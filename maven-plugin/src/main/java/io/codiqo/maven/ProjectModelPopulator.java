...
class ProjectModelPopulator implements SubmissionPopulator {
    private final Log log;

    @Override
    public void accept(SubmissionContext ctx) {
        populateDefaultBranch(ctx);
    ...
    private void populateDefaultBranch(SubmissionContext ctx) {
    ...
    private void populateModules(SubmissionContext ctx) {
