...
class JvmOptionsFilterTest {
    ...
    void filtersJenkinsfileMavenOpts() {
        ...
        assertEquals(List.of("-Xms8g"), JvmOptionsFilter.keepMemory(input));
    }
    @Test
    void keepsHeapAndStack() {
        assertEquals(List.of("-Xmx2g", "-Xms512m", "-Xss256k"), JvmOptionsFilter.keepMemory("-Xmx2g -Xms512m -Xss256k"));
    }
    @Test
    ...
    void handlesMultipleWhitespace() {
        assertEquals(List.of("-Xms8g", "-Xmx16g"), JvmOptionsFilter.keepMemory("-Xms8g    -Xmx16g"));
    }
    @Test
